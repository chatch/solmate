...
import {MockERC721WithStorageStruct} from "./utils/mocks/MockERC721WithStorageStruct.sol";

import {ERC721TokenReceiver} from "../tokens/ERC721WithStorageStruct.sol";
...
contract ERC721Test is DSTestPlus {
    MockERC721WithStorageStruct token;

    function setUp() public {
        token = new MockERC721WithStorageStruct("Token", "TKN");
    }
    ...
    function testMetadata(string memory name, string memory symbol) public {
        MockERC721WithStorageStruct tkn = new MockERC721WithStorageStruct(name, symbol);
